...
from langgraph_mcp import tavily_mcp_search
tavily = TavilyClient()
...
result = graph.invoke(
    {
        "userquery": "I am planning a 3 day trip from Delhi to Bombay. Can you help me with the best flight options and itinerary details?"
    }
)
